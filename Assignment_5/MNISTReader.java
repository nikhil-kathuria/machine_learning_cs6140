...
/**
 * Created by nikhilk on 11/17/15.
 */
...
public class MNISTReader {
    ...
    ArrayList<double [][]> imageset = new ArrayList<>();
    double [] labelset;

    public void readImage() throws IOException{

        DataInputStream labels = new DataInputStream(new FileInputStream(labelpath));
        DataInputStream images = new DataInputStream(new FileInputStream(imagepath));
